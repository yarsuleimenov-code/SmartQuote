...
const warningPresentationJs = fs.readFileSync("js/warningPresentation.js", "utf8");
...
assert(quoteDraftHtml.includes("addItemBottom"), "Expected bottom Add Item button in Quote Draft for long item lists.");
assert(quoteDraftHtml.includes("Quote Readiness"), "Expected Quote Readiness panel in Quote Draft.");
assert(quoteDraftHtml.includes("warningCenter"), "Expected normalized Warning Center in Quote Draft.");
assert(quoteDraftHtml.includes("js/warningPresentation.js"), "Expected Warning Presentation adapter to load before Quote Draft UI.");
assert(quoteDraftUi.includes("Protection Plan"), "Expected broker-facing Protection Plan label in Quote Draft.");
assert(quoteDraftUi.includes("renderWarningCenter"), "Expected Quote Draft UI to render normalized warning records.");
assert(quoteDraftUi.includes("enforcementEnabled"), "Expected warning enforcement to remain governed separately.");
assert(warningPresentationJs.includes("blocksEstimate: true"), "Expected blocking intent in warning contract adapter.");
assert(warningPresentationJs.includes("enforcementEnabled: false"), "Expected manager/blocking enforcement to remain disabled.");
...
assert(!quoteDraftUi.includes("RV standard included protection."), "Expected RV helper copy not to add height in compact item rows.");
assert(quoteDraftUi.includes("Requires declared value."), "Expected compact FVP declared value helper.");
...
assert(quickQuoteHtml.includes("quickAddItemBottom"), "Expected bottom Add Quick Item button for long quick item lists.");
...
assert(quickQuoteJs.includes('protectionPlan: "RV"'), "Expected Quick Quote transfer to default Full Quote protection to RV.");
assert(quickQuoteJs.includes('protectionLegacyType: "Basic Liability"'), "Expected Quick Quote transfer to preserve protection compatibility.");
assert(quickQuoteJs.includes("pickupDirect: false"), "Expected Quick Quote transfer to default Direct Pickup off.");
assert(quickQuoteJs.includes("deliveryDirect: false"), "Expected Quick Quote transfer to default Direct Delivery off.");
assert(quickQuoteJs.includes("elevatorAvailable: true"), "Expected Quick Quote transfer to default elevator availability on.");
assert(quickQuoteJs.includes("Catalog transfer"), "Expected compact catalog transfer item comment.");
assert(quickQuoteJs.includes('byId("quickAddItem").addEventListener("click", addQuickItem)'), "Expected top Quick Quote add button to use shared add handler.");
assert(quickQuoteJs.includes('byId("quickAddItemBottom").addEventListener("click", addQuickItem)'), "Expected bottom Quick Quote add button to use shared add handler.");
